...
elseif (NOT "${SNAPPY_HOME}" STREQUAL "")
  ...
  list (APPEND ORC_VENDOR_DEPENDENCIES "vendored_snappy:${SNAPPY_STATIC_LIB_NAME}")
  list (APPEND ORC_INSTALL_INTERFACE_TARGETS "$<INSTALL_INTERFACE:vendored_snappy>")
endif ()
...
elseif (NOT "${ZLIB_HOME}" STREQUAL "")
  ...
  list (APPEND ORC_VENDOR_DEPENDENCIES "vendored_zlib:${ZLIB_STATIC_LIB_NAME}")
  list (APPEND ORC_INSTALL_INTERFACE_TARGETS "$<INSTALL_INTERFACE:vendored_zlib>")
endif ()
...
elseif (NOT "${ZSTD_HOME}" STREQUAL "")
  ...
  list (APPEND ORC_VENDOR_DEPENDENCIES "vendored_zstd:${ZSTD_STATIC_LIB_NAME}")
  list (APPEND ORC_INSTALL_INTERFACE_TARGETS "$<INSTALL_INTERFACE:vendored_zstd>")
endif ()
...
elseif (NOT "${LZ4_HOME}" STREQUAL "")
  ...
  list (APPEND ORC_VENDOR_DEPENDENCIES "vendored_lz4:${LZ4_STATIC_LIB_NAME}")
  list (APPEND ORC_INSTALL_INTERFACE_TARGETS "$<INSTALL_INTERFACE:vendored_lz4>")
endif ()
...
elseif (NOT "${PROTOBUF_HOME}" STREQUAL "")
  ...
  list (APPEND ORC_VENDOR_DEPENDENCIES "vendored_protobuf:${PROTOBUF_STATIC_LIB_NAME}")
  list (APPEND ORC_INSTALL_INTERFACE_TARGETS "$<INSTALL_INTERFACE:vendored_protobuf>")
endif ()
