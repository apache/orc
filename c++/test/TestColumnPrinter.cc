...
TEST(TestColumnPrinter, TimestampColumnPrinter) {
  ...
  const char* expected[] = {"\"2015-01-01 00:00:00.0\"",        "\"2000-07-11 00:00:00.0\"",
...
TEST(TestColumnPrinter, DateColumnPrinter) {
  ...
  batch.data[8] = 16729;
  batch.data[9] = 12275;
  const char* expected[] = {"\"1970-01-01\"", "\"2002-02-20\"", "\"1969-07-20\"", "\"1879-03-14\"",
                            "\"1998-09-20\"", "\"1955-11-05\"", "\"2000-02-29\"", "\"1985-10-12\"",
                            "\"2015-10-21\"", "\"2003-08-11\""};
  printer->reset(batch);
  for (uint64_t i = 0; i < batch.numElements; ++i) {
#ifndef HAS_PRE_1970
