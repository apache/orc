...
namespace orc {
  ...
  const uint32_t ClosestFixedBitsMap[65] = {
    ...
    26, 26, 28, 28, 30, 30, 32, 32, 40, 40, 40, 40, 40, 40, 40, 40,
  ...
  const uint32_t ClosestAlignedFixedBitsMap[65] = {
      ...
      32, 32, 32, 32, 33, 33, 32, 32, 40, 40, 40, 40, 40, 40, 40, 40,
      48, 48, 48, 48, 48, 48, 48, 48,
      56, 56, 56, 56, 56, 56, 56, 56,
      64, 64, 64, 64, 64, 64, 64, 64
  };
  ...
  const uint32_t BitWidthToFBSMap[65] = {
      0, FixedBitSizes::ONE, FixedBitSizes::TWO, FixedBitSizes::THREE, FixedBitSizes::FOUR,
