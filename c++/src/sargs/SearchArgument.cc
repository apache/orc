...
SearchArgumentBuilder& SearchArgumentBuilderImpl::compareOperator(PredicateLeaf::Operator op,
                                                                  T column, PredicateDataType type,
                                                                  Literal literal) {
...
SearchArgumentBuilder& SearchArgumentBuilderImpl::equals(uint64_t columnId, PredicateDataType type,
                                                         Literal literal) {
  if (literal.isNull()) {
...
SearchArgumentBuilder& SearchArgumentBuilderImpl::between(uint64_t columnId, PredicateDataType type,
                                                          Literal lower, Literal upper) {
