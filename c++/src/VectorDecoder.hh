...
#define ORC_VECTOR_BIT_MASK(x) ((ORC_VECTOR_ONE_64U << (x)) - 1u)  /**< Bit mask below bit position */

#define ORC_VECTOR_BITS_2_WORD(x) (((x) + 15u) >> 4u)        /**< Convert a number of bits to a number of words */
#define ORC_VECTOR_BITS_2_DWORD(x) (((x) + 31u) >> 5u)       /**< Convert a number of bits to a number of double words */
...
static uint8_t shuffleIdxTable10u_0[64] = {
    ...
    1u, 0u, 2u, 1u, 3u, 2u, 4u, 3u, 6u, 5u, 7u, 6u, 8u, 7u, 9u, 8u,
    1u, 0u, 2u, 1u, 3u, 2u, 4u, 3u, 6u, 5u, 7u, 6u, 8u, 7u, 9u, 8u};
static uint16_t shiftTable10u[32] = {
    6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u};
static uint16_t permutexIdxTable10u[32] = {
    0u, 1u, 2u, 3u, 4u, 0x0, 0x0, 0x0, 5u, 6u, 7u, 8u, 9u, 0x0, 0x0, 0x0,
    10u, 11u, 12u, 13u, 14u, 0x0, 0x0, 0x0, 15u, 16u, 17u, 18u, 19u, 0x0, 0x0, 0x0};
...
static uint32_t shiftTable11u_0[16] = {
    0u, 6u, 12u, 2u, 8u, 14u, 4u, 10u, 0u, 6u, 12u, 2u, 8u, 14u, 4u, 10u};
static uint32_t shiftTable11u_1[16] = {
...
static uint8_t shuffleIdxTable12u_0[64] = {
    ...
    1u, 0u, 2u, 1u, 4u, 3u, 5u, 4u, 7u, 6u, 8u, 7u, 10u, 9u, 11u, 10u,
    1u, 0u, 2u, 1u, 4u, 3u, 5u, 4u, 7u, 6u, 8u, 7u, 10u, 9u, 11u, 10u};
static uint16_t shiftTable12u[32] = {
    4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u};
static uint32_t permutexIdxTable12u[16] = {
    0u, 1u, 2u, 0x0, 3u, 4u, 5u, 0x0, 6u, 7u, 8u, 0x0, 9u, 10u, 11u, 0x0};
...
static uint32_t shiftTable13u_0[16] = {
    0u, 10u, 4u, 14u, 8u, 2u, 12u, 6u, 0u, 10u, 4u, 14u, 8u, 2u, 12u, 6u};
static uint32_t shiftTable13u_1[16] = {
...
static uint32_t shiftTable15u_0[16] = {
    0u, 14u, 12u, 10u, 8u, 6u, 4u, 2u, 0u, 14u, 12u, 10u, 8u, 6u, 4u, 2u};
static uint32_t shiftTable15u_1[16] = {
...
static uint8_t shuffleIdxTable15u_1[64] = {
    ...
    3u, 2u, 1u, 0u, 7u, 6u, 5u, 0u, 11u, 10u, 9u, 0u, 15u, 14u, 13u, 0u,
    3u, 2u, 1u, 0u, 7u, 6u, 5u, 0u, 11u, 10u, 9u, 0u, 15u, 14u, 13u, 0u};
static uint32_t shiftTable15u_2[16] = {
    17u, 11u, 13u, 15u, 17u, 11u, 13u, 15u, 17u, 11u, 13u, 15u, 17u, 11u, 13u, 15u};
static uint32_t shiftTable15u_3[16] = {
    14u, 12u, 10u, 8u, 14u, 12u, 10u, 8u, 14u, 12u, 10u, 8u, 14u, 12u, 10u, 8u};
static uint64_t gatherIdxTable15u[8] = {
    0u, 8u, 15u, 23u, 30u, 38u, 45u, 53u};

// ------------------------------------ 17u -----------------------------------------
static uint32_t permutexIdxTable17u_0[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 3u, 4u, 4u, 5u, 5u, 6u, 6u, 7u, 7u, 8u};
static uint32_t permutexIdxTable17u_1[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 3u, 4u, 4u, 5u, 5u, 6u, 6u, 7u, 7u, 8u};
static uint64_t shiftTable17u_0[8] = {
    0u, 2u, 4u, 6u, 8u, 10u, 12u, 14u};
static uint64_t shiftTable17u_1[8] = {
...
static uint8_t shuffleIdxTable17u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 7u, 6u, 5u, 4u, 9u, 8u, 7u, 6u, 3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 7u, 6u, 5u, 4u, 9u, 8u, 7u, 6u};
static uint32_t shiftTable17u_2[16] = {
    15u, 14u, 13u, 12u, 11u, 10u, 9u, 8u, 15u, 14u, 13u, 12u, 11u, 10u, 9u, 8u};
static uint64_t gatherIdxTable17u[8] = {
    0u, 8u, 8u, 16u, 17u, 25u, 25u, 33u};

// ------------------------------------ 18u -----------------------------------------
static uint32_t permutexIdxTable18u_0[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 3u, 4u, 4u, 5u, 5u, 6u, 6u, 7u, 7u, 8u};
static uint32_t permutexIdxTable18u_1[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 3u, 4u, 5u, 6u, 6u, 7u, 7u, 8u, 8u, 9u};
static uint64_t shiftTable18u_0[8] = {
    0u, 4u, 8u, 12u, 16u, 20u, 24u, 28u};
static uint64_t shiftTable18u_1[8] = {
    14u, 10u, 6u, 2u, 30u, 26u, 22u, 18u};

static uint8_t shuffleIdxTable18u_0[64] = {
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 7u, 6u, 5u, 4u, 9u, 8u, 7u, 6u, 3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 7u, 6u, 5u, 4u, 9u, 8u, 7u, 6u,
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 7u, 6u, 5u, 4u, 9u, 8u, 7u, 6u, 3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 7u, 6u, 5u, 4u, 9u, 8u, 7u, 6u};
static uint32_t shiftTable18u_2[16] = {
    14u, 12u, 10u, 8u, 14u, 12u, 10u, 8u, 14u, 12u, 10u, 8u, 14u, 12u, 10u, 8u};
static uint64_t gatherIdxTable18u[8] = {
    0u, 8u, 9u, 17u, 18u, 26u, 27u, 35u};

// ------------------------------------ 19u -----------------------------------------
static uint32_t permutexIdxTable19u_0[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 3u, 4u, 4u, 5u, 5u, 6u, 7u, 8u, 8u, 9u};
static uint32_t permutexIdxTable19u_1[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 4u, 5u, 5u, 6u, 6u, 7u, 7u, 8u, 8u, 9u};
static uint64_t shiftTable19u_0[8] = {
    0u, 6u, 12u, 18u, 24u, 30u, 4u, 10u};
static uint64_t shiftTable19u_1[8] = {
...
static uint8_t shuffleIdxTable19u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 7u, 6u, 5u, 4u, 10u, 9u, 8u, 7u, 3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 8u, 7u, 6u, 5u, 10u, 9u, 8u, 7u};
static uint32_t shiftTable19u_2[16] = {
    13u, 10u, 7u, 12u, 9u, 6u, 11u, 8u, 13u, 10u, 7u, 12u, 9u, 6u, 11u, 8u};
static uint64_t gatherIdxTable19u[8] = {
...
static uint8_t shuffleIdxTable20u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 8u, 7u, 6u, 5u, 10u, 9u, 8u, 7u, 3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 8u, 7u, 6u, 5u, 10u, 9u, 8u, 7u};
static uint32_t shiftTable20u[16] = {
    12u, 8u, 12u, 8u, 12u, 8u, 12u, 8u, 12u, 8u, 12u, 8u, 12u, 8u, 12u, 8u};
static uint16_t permutexIdxTable20u[32] = {
    0u, 1u, 2u, 3u, 4u, 0x0, 0x0, 0x0, 5u, 6u, 7u, 8u, 9u, 0x0, 0x0, 0x0,
    10u, 11u, 12u, 13u, 14u, 0x0, 0x0, 0x0, 15u, 16u, 17u, 18u, 19u, 0x0, 0x0, 0x0};

// ------------------------------------ 21u -----------------------------------------
static uint32_t permutexIdxTable21u_0[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 3u, 4u, 5u, 6u, 6u, 7u, 7u, 8u, 9u, 10u};
static uint32_t permutexIdxTable21u_1[16] = {
    0u, 1u, 1u, 2u, 3u, 4u, 4u, 5u, 5u, 6u, 7u, 8u, 8u, 9u, 9u, 10u};
static uint64_t shiftTable21u_0[8] = {
    0u, 10u, 20u, 30u, 8u, 18u, 28u, 6u};
static uint64_t shiftTable21u_1[8] = {
...
static uint8_t shuffleIdxTable21u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 8u, 7u, 6u, 5u, 10u, 9u, 8u, 7u, 3u, 2u, 1u, 0u, 6u, 5u, 4u, 3u, 8u, 7u, 6u, 5u, 11u, 10u, 9u, 8u};
static uint32_t shiftTable21u_2[16] = {
    11u, 6u, 9u, 4u, 7u, 10u, 5u, 8u, 11u, 6u, 9u, 4u, 7u, 10u, 5u, 8u};
static uint64_t gatherIdxTable21u[8] = {
    0u, 8u, 10u, 18u, 21u, 29u, 31u, 39u};

// ------------------------------------ 22u -----------------------------------------
static uint32_t permutexIdxTable22u_0[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 4u, 5u, 5u, 6u, 6u, 7u, 8u, 9u, 9u, 10u};
static uint32_t permutexIdxTable22u_1[16] = {
    0u, 1u, 2u, 3u, 3u, 4u, 4u, 5u, 6u, 7u, 7u, 8u, 8u, 9u, 10u, 11u};
static uint64_t shiftTable22u_0[8] = {
    0u, 12u, 24u, 4u, 16u, 28u, 8u, 20u};
static uint64_t shiftTable22u_1[8] = {
...
static uint8_t shuffleIdxTable22u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 8u, 7u, 6u, 5u, 11u, 10u, 9u, 8u, 3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 8u, 7u, 6u, 5u, 11u, 10u, 9u, 8u};
static uint32_t shiftTable22u_2[16] = {
    10u, 4u, 6u, 8u, 10u, 4u, 6u, 8u, 10u, 4u, 6u, 8u, 10u, 4u, 6u, 8u};
static uint64_t gatherIdxTable22u[8] = {
    0u, 8u, 11u, 19u, 22u, 30u, 33u, 41u};

// ------------------------------------ 23u -----------------------------------------
static uint32_t permutexIdxTable23u_0[16] = {
    0u, 1u, 1u, 2u, 2u, 3u, 4u, 5u, 5u, 6u, 7u, 8u, 8u, 9u, 10u, 11u};
static uint32_t permutexIdxTable23u_1[16] = {
    0u, 1u, 2u, 3u, 3u, 4u, 5u, 6u, 6u, 7u, 7u, 8u, 9u, 10u, 10u, 11u};
static uint64_t shiftTable23u_0[8] = {
    0u, 14u, 28u, 10u, 24u, 6u, 20u, 2u};
static uint64_t shiftTable23u_1[8] = {
...
static uint8_t shuffleIdxTable23u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 5u, 4u, 3u, 2u, 8u, 7u, 6u, 5u, 11u, 10u, 9u, 8u, 3u, 2u, 1u, 0u, 6u, 5u, 4u, 3u, 9u, 8u, 7u, 6u, 12u, 11u, 10u, 9u};
static uint32_t shiftTable23u_2[16] = {
    9u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 2u, 3u, 4u, 5u, 6u, 7u, 8u};
static uint64_t gatherIdxTable23u[8] = {
...
static uint8_t shuffleIdxTable24u_0[64] = {
    ...
    2u, 1u, 0u, 0xFF, 5u, 4u, 3u, 0xFF, 8u, 7u, 6u, 0xFF, 11u, 10u, 9u, 0xFF, 2u, 1u, 0u, 0xFF, 5u, 4u, 3u, 0xFF, 8u, 7u, 6u, 0xFF, 11u, 10u, 9u, 0xFF};
static uint32_t permutexIdxTable24u[16] = {
    0u, 1u, 2u, 0x0, 3u, 4u, 5u, 0x0, 6u, 7u, 8u, 0x0, 9u, 10u, 11u, 0x0};

// ------------------------------------ 26u -----------------------------------------
static uint32_t permutexIdxTable26u_0[16] = {
    0u, 1u, 1u, 2u, 3u, 4u, 4u, 5u, 6u, 7u, 8u, 9u, 9u, 10u, 11u, 12u};
static uint32_t permutexIdxTable26u_1[16] = {
    0u, 1u, 2u, 3u, 4u, 5u, 5u, 6u, 7u, 8u, 8u, 9u, 10u, 11u, 12u, 13u};
static uint64_t shiftTable26u_0[8] = {
    0u, 20u, 8u, 28u, 16u, 4u, 24u, 12u};
static uint64_t shiftTable26u_1[8] = {
...
static uint8_t shuffleIdxTable26u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 6u, 5u, 4u, 3u, 9u, 8u, 7u, 6u, 12u, 11u, 10u, 9u, 3u, 2u, 1u, 0u, 6u, 5u, 4u, 3u, 9u, 8u, 7u, 6u, 12u, 11u, 10u, 9u};
static uint32_t shiftTable26u_2[16] = {
    6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u, 6u, 4u, 2u, 0u};
static uint64_t gatherIdxTable26u[8] = {
    0u, 8u, 13u, 21u, 26u, 34u, 39u, 47u};
...
static uint8_t shuffleIdxTable28u_0[64] = {
    ...
    3u, 2u, 1u, 0u, 6u, 5u, 4u, 3u, 10u, 9u, 8u, 7u, 13u, 12u, 11u, 10u, 3u, 2u, 1u, 0u, 6u, 5u, 4u, 3u, 10u, 9u, 8u, 7u, 13u, 12u, 11u, 10u};
static uint32_t shiftTable28u[16] = {
    4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u, 4u, 0u};
static uint16_t permutexIdxTable28u[32] = {
    0u, 1u, 2u, 3u, 4u, 5u, 6u, 0x0, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 0x0,
    14u, 15u, 16u, 17u, 18u, 19u, 20u, 0x0, 21u, 22u, 23u, 24u, 25u, 26u, 27u, 0x0};

// ------------------------------------ 30u -----------------------------------------
static uint32_t permutexIdxTable30u_0[16] = {
    0u, 1u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u};
static uint32_t permutexIdxTable30u_1[16] = {
    0u, 1u, 2u, 3u, 4u, 5u, 6u, 7u, 8u, 9u, 10u, 11u, 12u, 13u, 14u, 15u};
static uint64_t shiftTable30u_0[8] = {
    0u, 28u, 24u, 20u, 16u, 12u, 8u, 4u};
static uint64_t shiftTable30u_1[8] = {
...
static uint8_t shuffleIdxTable30u_1[64] = {
    ...
    7u, 6u, 5u, 4u, 3u, 0u, 0u, 0u, 15u, 14u, 13u, 12u, 11u, 0u, 0u, 0u, 7u, 6u, 5u, 4u, 3u, 0u, 0u, 0u, 15u, 14u, 13u, 12u, 11u, 0u, 0u, 0u};
static uint64_t shiftTable30u_2[8] = {
    34u, 30u, 34u, 30u, 34u, 30u, 34u, 30u};
static uint64_t shiftTable30u_3[8] = {
    28u, 24u, 28u, 24u, 28u, 24u, 28u, 24u};
static uint64_t gatherIdxTable30u[8] = {
    0u, 8u, 15u, 23u, 30u, 38u, 45u, 53u};
