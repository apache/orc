...
public enum OrcConf {
  ...
  private String lookupValue(Configuration conf) {
    String result = conf.get(attribute);
    if (result == null) {
  ...
  public void setInt(Configuration conf, int value) {
    conf.set(attribute, Integer.toString(value));
  }
  ...
  public void setLong(Configuration conf, long value) {
    conf.set(attribute, Long.toString(value));
  }
  ...
  public void setBoolean(Configuration conf, boolean value) {
    conf.set(attribute, Boolean.toString(value));
  }
  ...
  public void setDouble(Configuration conf, double value) {
    conf.set(attribute, Double.toString(value));
  }
}
