 ...
 *
 */
public class WriterImplV2Core extends WriterImplCore {

  private static final Logger LOG = LoggerFactory.getLogger(WriterImplV2Core.class);

  public WriterImplV2Core(String path,
