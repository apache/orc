...
import org.apache.orc.core.MemoryManager;
...
import org.apache.orc.impl.PhysicalFsWriterCore;
 ...
 *
 */
public class WriterImplCore implements WriterInternal, MemoryManager.Callback {

  private static final Logger LOG = LoggerFactory.getLogger(WriterImplCore.class);
  ...
  public WriterImplCore(String path,
                    OrcFile.WriterOptions opts) throws IOException {
    this.path = path;
    this.conf = opts.getCoreConfiguration();
    ...
    this.physicalWriter = opts.getPhysicalWriter() == null ?
                              new PhysicalFsWriterCore(path, opts, encryption) :
    ...
    if (callback != null) {
      callbackContext = () -> WriterImplCore.this;
    } else {
  ...
  private long writePostScript() throws IOException {
    OrcProto.PostScript.Builder builder =
        OrcProto.PostScript.newBuilder()
            .setMagic(org.apache.orc.OrcFile.MAGIC)
