 ...
 */
public class MemoryManagerImplCore implements MemoryManager {

  private final long totalMemoryPool;
  private final Map<String, WriterInfo> writerList = new HashMap<>();
   ...
   *             pool.
   */
  public MemoryManagerImplCore(Configuration conf) {
   ...
   */
  public MemoryManagerImplCore(long poolSize) {
   ...
   */
  @Override
  public synchronized void addWriter(String path, long requestedAllocation,
                              Callback callback) {
   ...
   */
  @Override
  public synchronized void removeWriter(String path) {
