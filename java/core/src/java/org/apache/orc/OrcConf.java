...
public enum OrcConf {
  ...
  KRYO_SARG_BUFFER("orc.kryo.sarg.buffer", null, 4096,
      "The kryo buffer size for SearchArgument for predicate pushdown."),
  KRYO_SARG_MAX_BUFFER("orc.kryo.sarg.buffer.max", null, 10485760,
      "The maximum kryo buffer size for SearchArgument for predicate pushdown."),
